...
- 立地の埋め込み 8 次元・seed 42・入力 16 次元（MIT(モデル) / 出典は上記の派生／取得 2026-09-10）
...
| 検証再構成 MSE | 0.045203 |
| 再構成 MSE（全件） | 0.042619 |
| 同次元 PCA の再構成 MSE | 0.049453 |
| Top-20 近傍の Jaccard（素朴な余弦類似度との重なり） | 0.3194 |
